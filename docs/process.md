...
- **UI実装完了**: T010a, UI001 (2タスク)
- **残りタスク**: T013〜T018, UI002 (7タスク)
  - T013: スタッフ向けカレンダー
  - T014: 管理者向けカレンダー
  - T015: 勤務実績集計
  - T016: Stripe課金管理
...
| UI002 | ランディングページ | ランディングページ作成 | UI | ランディング | 中 | [ ] | サービス紹介、機能説明、料金プラン、CTAボタン、モダンなデザイン |
...
5. ⏳ **ランディングページ**（UI002）でサービス紹介ページ作成 - **未着手**  
